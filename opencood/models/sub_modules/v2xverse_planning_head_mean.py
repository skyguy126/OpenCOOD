# -*- coding: utf-8 -*-
# Original V2Xverse WaypointPlanner_e2e pooling (uniform spatial mean).
# Snapshot of v2xverse_planning_head.py before the attention change
# (acd2f76). Do not add spatial_attn here.
...
class V2XVerseMeanPlanningHead(nn.Module):
    """
    ...
    def __init__(self, feature_dir: int = 384, input_frame: int = 5,
        ...
        super(V2XVerseMeanPlanningHead, self).__init__()
        assert input_frame == 5, (
            "V2XVerseMeanPlanningHead requires input_frame=5 "
